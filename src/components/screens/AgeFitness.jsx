...
import styles from "./AgeFitness.module.css";

const LABEL = "[AGE CALIBRATION]";
...
/**
 * SCREEN 05B — AGE INPUT (Fitness / Both path)
 * Split layout mirrors 04B. Hologram persists at 40% opacity showing the
 * gender selected in the previous screen. No hologram interaction here.
 */
export default function AgeFitness() {
  ...
  const proceed = useCallback(() => {
    ...
    setTimeout(() => router.push(nextScreen(path, "/screen-05b")), 600);
  }, [router]);
        ...
        <div className={styles.leftSide}>
          <div className={styles.panel}>
            ...
            {showSys1 && (
              ...
              >
                Age recorded. Fitness baseline parameters established.
              </div>
            )}
          </div>
        </div>

        {/* ── RIGHT: hologram persists from 04B ── */}
        <div className={styles.rightSide}>
          <HologramFigure gender={gender} glow={false} />
        </div>
      </div>
